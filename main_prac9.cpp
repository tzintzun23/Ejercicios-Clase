...
//Práctica: 9
//Versión VS: 2017
//Instrucciones: Se muestra una mesa de ajedrez hecha con un
// material de metal. Además se agregó transparencia a los 
// cuadrados blancos del tablero de ajedrez, por lo que en esos
// espacios se nota el material que hay debajo, es decir, el
// metal.
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_Ajedrez2.LoadTGA("02trans.tga");
	t_Ajedrez2.BuildGLTexture();
	t_Ajedrez2.ReleaseImage();
}
