...
//Práctica: 11
//Versión VS: 2017
//Instrucciones: En este ejercicio se muestra un monito realizando
// la animación de un pequeño baile. Este baile se borrará al
// terminar la ejecución de esta prueba. Pero se queda demostrado
// en el video.
...
float posX = 0, posY = 2.5, posZ = -3.5, rotRodIzq = 0, rotRodDer = 0, brazoIzq = 0, brazoDer = 0;
float giroMonito = 0;
...
typedef struct _frame
{
	...
	float rotRodDer; float brazoIzq; float brazoDer;
	...
	float rotRodIzq;
	float rotRodDerInc; float brazoIzqInc; float brazoDerInc;
	float rotInc;
	float giroMonito;
	float giroMonitoInc;
