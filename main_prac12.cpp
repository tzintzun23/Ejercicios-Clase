...
//Práctica: 12
//Versión VS: 2017
//Instrucciones: En este ejercicio se realiza la animación de un
// coche, el cual puede ir en una dirección o dar la vuelta e ir
// en la dirección contraria. Para activar la animación "de frente"
// se realiza presionando la tecla "i", para voltear e ir en
// dirección contraria se realiza presionando la tecla "r".
...
void animacion()
{
	...
	if (circuito)
	{
		...
		if (recorrido3)
		{
			rotKit = 210;
			movKitX = movKitX - 0.4;
			printf("Recorrido 3 en X: %f \n", movKitX);
			movKitZ--;
			printf("Recorrido 3 en Z: %f \n", movKitZ);
			if (movKitZ < -160)
			{
				recorrido3 = false;
				recorrido5 = true;
...
void keyboard ( unsigned char key, int x, int y )  // Create Keyboard Function
{
	switch ( key ) {
		...
		case 'r':		//Poner en marcha al contrario el coche
		case 'R':
			circuito = false;
